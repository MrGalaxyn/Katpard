...
/** @lends ToolbarTempl */
{
    ...
    buttonTag:
        SPAN({"class": "$button|getClassName btn btn-middle btn-primary", title: "$button.tooltiptext",
            $text: "$button|hasLabel", onclick: "$button|getCommand"},
            "$button|getLabel"
        ),

    dropDownTag:
        SPAN({"class": "$button|getClassName btn btn-middle btn-primary dropDown",
            _repObject: "$button",
    ...
    onDropDown: function(event)
    {
        ...
        var target = e.target;
        var button = Lib.getAncestorByClass(target, "btn btn-middle btn-primary");
