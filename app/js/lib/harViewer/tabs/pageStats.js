...
define([
    ...
    "lib/harViewer/preview/harSchema",
...
function(Domplate, Lib, HarSchema, HarModel, Cookies, InfoTip, Trace) { with (Domplate) {
...
TimingPie.prototype = Lib.extend(Pie.prototype,
{
    ...
    data: [
        {value: 0, label: 'Blocked', color: "rgb(228, 214, 193)"},
        {value: 0, label: 'DNS',     color: "rgb(119, 192, 203)"},
        {value: 0, label: 'SSL/TLS',     color: "rgb(168, 196, 173)"},
        {value: 0, label: 'Connect', color: "rgb(179, 222, 93)"},
        {value: 0, label: 'Send',    color: "rgb(224, 171, 157)"},
        {value: 0, label: 'Wait',    color: "rgb(163, 150, 190)"},
        {value: 0, label: 'Receive', color: "rgb(194, 194, 194)"}
    ],
...
ContentPie.prototype = Lib.extend(Pie.prototype,
{
    ...
    data: [
        {value: 0, label:'HTML/Text', color: "rgb(174, 234, 218)"},
        {value: 0, label: 'JavaScript', color: "rgb(245, 230, 186)"},
        {value: 0, label: 'CSS', color: "rgb(212, 204, 219)"},
        {value: 0, label: 'Image', color: "rgb(220, 171, 181)"},
        {value: 0, label: 'Flash', color: "rgb(166, 156, 222)"},
        {value: 0, label: 'Others', color: "rgb(229, 171, 255)"}
    ],
...
TrafficPie.prototype = Lib.extend(Pie.prototype,
{
    ...
    data: [
        {value: 0, label: 'Headers Sent', color: "rgb(247, 179, 227)"},
        {value: 0, label: 'Bodies Sent', color: "rgb(226, 160, 241)"},
        {value: 0, label: 'Headers Received', color: "rgb(166, 232, 166)"},
        {value: 0, label: 'Bodies Received', color: "rgb(168, 196, 173)"}
    ]
});
...
CachePie.prototype = Lib.extend(Pie.prototype,
{
    ...
    data: [
        {value: 0, label: 'Downloaded', color: "rgb(182, 182, 182)"},
        {value: 0, label: 'Partial', color: "rgb(218, 218, 218)"},
        {value: 0, label: 'From Cache', color: "rgb(239, 239, 239)"}
    ],
