...
define([
	...
	// prevent append 2 previewtab
        this.removeTab("Preview");
    ...
    /** @lends HarView */
    {
        ...
        appendPreview: function(jsonString)
        {
            ...
            Lib.fireEvent(this.content, "onViewerHARLoaded");
        },
