...
define([
    ...
    "lib/harViewer/tabs/search",
    "lib/harViewer/core/dragdrop",
    "lib/harViewer/domplate/domTree",
    "lib/harViewer/core/cookies",
    "lib/harViewer/domplate/tableView",
    "lib/harViewer/core/trace",
    "lib/harViewer/json-query/JSONQuery"
],

function(Domplate, TabView, Lib, Toolbar, Search, DragDrop, DomTree, Cookies,
    TableView, Trace) {
...
DomTab.prototype = domplate(TabView.Tab.prototype,
{
    ...
    onUpdateBody: function(tabView, body)
    {
        ...
        if (Lib.isIE)
        {
            ...
            searchInput.setAttribute("title", 'You need Mozilla or WebKit based browser to search in HAR');
    ...
    updateSearchResultsUI: function()
    {
        ...
        if (searchInput)
        {
            var placeholder = value ? 'JSON Query' : 'Search';
